...
**CryptoChronicles** is a mobile web application that uses [API](https://cryptocointracker.com/api/coinstats) to display the list of cryptocurrencies and their market capitalization. Built with React and Redux.
...
`git clone git@github.com:M1rn4/history-cryptocurrency.git`
...
Feel free to check the [issues page](https://github.com/M1rn4/history-cryptocurrency/issues).
